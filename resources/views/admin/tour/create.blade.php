			...
			<div class="row">
                <div class="col-lg-12">
					<ul class="nav nav-pills-shadow nav-responsive mb-2">
						...
						<li class="nav-item"> 
							<a class="nav-link mb-0 active" href="{{ route('admin.tour.create') }}">Add tour</a> 
						</li>
						<li class="nav-item"> 
                                ...
                                <form action="{{ route('admin.tour.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="title" class="form-control title" placeholder="Tour title">
                                        </div>

                                        <!-- Slug -->
                                        <div class="col-md-6">
                                            <label class="form-label">Slug</label>
                                            <input type="text" name="slug" class="form-control slug" placeholder="tour-title">
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" step="0.01" name="price" class="form-control" placeholder="1000">
                                        </div>

                                        <!-- Discount Price -->
                                        <div class="col-md-6">
                                            <label class="form-label">Discount Price</label>
                                            <input type="number" step="0.01" name="discount_price" class="form-control" placeholder="900">
                                        </div>
