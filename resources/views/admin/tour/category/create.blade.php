			...
			<div class="row">
                <div class="col-lg-12">
					<ul class="nav nav-pills-shadow nav-responsive mb-2">
						...
						<li class="nav-item"> 
							<a class="nav-link mb-0 active" href="{{ route('admin.tour.category.create') }}">Add category</a> 
						</li>
					</ul>
				</div>
                <div class="col-lg-12">
                                ...
                                <form action="{{ route('admin.tour.category.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="name" class="form-control title" placeholder="Category name">
                                        </div>
                                        <div class="col-md-6">
