			...
			<div class="col-lg-6">
				<div class="card bg-light p-4">
					...
					<div class="card-body p-0">
						<form class="row g-4" method="POST" action="{{ route('contact.store') }}" enctype="multipart/form-data">
                        @csrf    
                        <div class="col-md-12">
                                @if(session('success'))
							...
							<!-- Button -->
							<div class="col-12">
								<button class="btn btn-dark mb-0" id="submitBtn" disabled type="submit">Send Message</button>
							</div>	
						</form>
					</div>
					<!-- Card body END -->
